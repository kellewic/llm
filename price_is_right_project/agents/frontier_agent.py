...
class FrontierAgent(Agent):
    ...
    def __init__(self, collection):
        ...
        self.log("Initializing - connecting to model")
    ...
    def find_similars(self, description: str):
        ...
        """
        self.log("Performing RAG search of Chroma datastore to find 5 similar products")
    ...
    def price(self, description: str) -> float:
        ...
        self.log(f"About to call {self.MODEL} with context including 5 similar products")
